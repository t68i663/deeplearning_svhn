...
def get_dataset_batch(ds_name):
    ...
    ds = tf.data.Dataset()
    ds = ds.from_generator(ds_gnr, output_types=(tf.float32, tf.int32),)
    if ds_name == 'train':
...
def main():
    ...
    if args.loss == 'softmax':
        ...
        print('choosing plus-one-abs-max')
        ...
        print('choosing non-negative-max')
    else:
